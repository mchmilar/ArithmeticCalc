...
public class SecondArithmeticRecursion {
	...
	public static void main(String[] args) {
		System.out.println(evaluateEquation("2*(5 +1)- 3 * 2 >= 6^3.1 + 5"));
	}
	
	
	private static boolean evaluateEquation(String expression) {
		...
		for (int i = 0; i < parsedExpression.length; i++) {
			...
			System.out.println(parsedExpression[i]);
		}
	...
	private static String resolveExpression(String expression) {
		...
		if (!containOps(expression))
			...
			//boolean hasUnaryMinus = containsUnaryMinus(expression);
...
//	private static boolean containsUnaryMinus(String e) {
//		boolean flag = false;
//		
//		for (int i =)
//		
